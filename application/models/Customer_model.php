...
class Customer_model extends CI_Model {
    ...
    var $table = 'customer';
    var $column_order = array('customerkey','name','address','email','phone','strategy',null);
    var $column_search = array('customerkey','name','address','email','phone','strategy');
    var $order = array('customerkey' => 'asc'); // default order
